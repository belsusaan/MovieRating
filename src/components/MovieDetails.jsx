...
/**
* Componente que muestra los detalles de una pelicula y permite al usuario
...
* @param {Function} props.onAddWatched - Función para agregar la pelicula a la lista
de vistas.
...
export const MovieDetails = ({
  ...
  // Verifica si la pelicula ya está en la lista de vistas
  ...
  /**
   * Maneja la adición de una pelicula a la lista de vistas.
   */
  function handleAdd() {
    const newMovie = {
      imdbID: selectedId,
